...
cover:
  image: "cover.png"
  alt: "Subscription billing screen on a laptop"
  relative: true
reviewed_by: ""
reviewer_link: ""
---
...
<div style="margin: 2rem 0; text-align: center;">
  <a href="/subscription-cost-infographics.html" style="display: inline-flex; align-items: center; gap: 10px; padding: 14px 28px; background: linear-gradient(135deg, #3b82f6, #8b5cf6); color: white; border-radius: 12px; font-weight: 600; text-decoration: none; box-shadow: 0 4px 15px rgba(59, 130, 246, 0.4); transition: all 0.3s ease;">
...
{{< img src="image1.png" alt="screenshot showing an infographic of monthly vs yearly prices" class="center-img-400">}}
